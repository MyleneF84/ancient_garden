...
class Admins::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admins_category" do
    assert_difference("Admins::Category.count") do
      post admins_categories_url, params: { admins_category: { description: @admins_category.description, name: @admins_category.name } }
    end
  ...
  test "should update admins_category" do
    patch admins_category_url(@admins_category), params: { admins_category: { description: @admins_category.description, name: @admins_category.name } }
